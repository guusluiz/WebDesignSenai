...
function mudarCorQuadrado() {
    ...
    //5° falar qual o valor da propriedade ("#f53487")
    document.getElementById("quadrado").style.backgroundColor = "#f53487"
}
function mudarCorQuadradoDnv(){
    document.getElementById("quadrado").style.backgroundColor = "#55a2a3"
}
